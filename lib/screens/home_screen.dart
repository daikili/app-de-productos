...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void getData() {
    fecthApi.fetchData();
    print(
        "esta es la data :)  ${stateList.currentListAlertPet} ,,, ${_setProvider.chageForFilter}");
  }
  ...
  void initState() {
    ...
    print(
        "esta es la data :)  ${stateList.currentListAlertPet} ,,, ${_setProvider.chageForFilter}");
    // print("esta es la data :)  ${stateList.stateListCategory}");
    // print("esta es la data :)  ${stateList.listCategory}");
    // print("esta es la data :)  ${stateList.currentListAlertPet}");
    // print("esta es la data :)  ${stateListBase}");
  }
